...
def upgrade() -> None:
    """Create file segments and references with hybrid indexes."""
    ...
    op.create_table(
        ...
        sa.Column("filename", sa.String(length=500), server_default="", nullable=False),
        sa.Column("mime_type", sa.String(length=100), server_default="", nullable=False),
        sa.Column("header_path", sa.String(length=500), server_default="", nullable=False),
