...
class Filter:
    ...
    _TOOL_POLICY = (
        ...
        "decisions, projects, or previously discussed topics, call "
        ...
        "- Files attached to THIS chat: use the native file tools (list/query/view) "
        "first. Use assistant-core only for files from EARLIER chats or uploads not "
        "visible here (search_personal_context / read_full_document).\n"
